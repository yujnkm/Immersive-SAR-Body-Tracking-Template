...
namespace Igloo.UI
{
    public class HorizontalSelector : MonoBehaviour
    {
        ...
        public void SetValueWithoutNotify(int idx) {
            Debug.Log("<b>[Igloo]</b> Setting Horizontal Selector to position : " + idx);
            defaultIndex = idx;
            selectorAnimator = gameObject.GetComponent<Animator>();
            label = transform.Find("Text").GetComponent<TextMeshProUGUI>();
            labeHelper = transform.Find("Text Helper").GetComponent<TextMeshProUGUI>();

            // itemList[idx].onValueChanged.Invoke();

            label.text = itemList[idx].itemTitle;
            labeHelper.text = label.text;
            index = idx;
        }
