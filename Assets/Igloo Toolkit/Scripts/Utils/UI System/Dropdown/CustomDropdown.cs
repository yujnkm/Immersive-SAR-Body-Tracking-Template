...
namespace Michsky.UI.ModernUIPack
{
    public class CustomDropdown : MonoBehaviour, IPointerExitHandler
    {
        ...
        public UnityEvent OnItemSelcted;
        public UnityEvent OnOpenDropDown;
        ...
        public void ItemSelected() {
            OnItemSelcted.Invoke();
        }


        public void Animate()
        {
            if (!dropdownAnimator) dropdownAnimator = gameObject.GetComponent<Animator>();
